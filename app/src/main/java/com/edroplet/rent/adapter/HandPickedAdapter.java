...
public class HandPickedAdapter extends BaseAdapter {
	...
	public HandPickedAdapter(Context context) {
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(context).inflate(R.layout.hand_picked_item,
					null);
		...
		HandPickedData handPickedData = datas.get(arg0);
		viewHolder.favoriteCount.setText(handPickedData.getFavoriteCount());
		viewHolder.pictureCount.setText(handPickedData.getPictureCount());
