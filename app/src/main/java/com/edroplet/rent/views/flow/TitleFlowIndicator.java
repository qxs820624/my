 ...
 */
package com.edroplet.rent.views.flow;
...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.edroplet.rent.widget.flow.FlowIndicator#onScrolled(int, int, int,
	 * int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.edroplet.rent.widget.flow.ViewFlow.ViewSwitchListener#onSwitched(android
	 * .view.View, int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.edroplet.rent.widget.flow.FlowIndicator#setViewFlow(org.taptwo.android
	 * .widget.ViewFlow)
	 */
	@Override
